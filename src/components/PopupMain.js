        ...
        <div className="popupMain--container">
            ...
            <div className="popupMain--header">
                ...
                <div className="popupMain--links">
                    <a href={props.item.pageUrl}  className="popupMain--site__link" target="_blank" rel="noreferrer">
                        <ion-icon name="browsers-outline"></ion-icon>
                    </a>
                    <a href={props.item.codeUrl} target="_blank" rel="noreferrer">
            ...
            <img src={props.item.imageSrc} className="popupMain--image" alt="" />
